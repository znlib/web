    ...
    <?php foreach ($attributes as $attributeEntity): ?>
        <th>
            ...
            if ($attributeEntity->getSortAttribute()) {
                echo \ZnLib\Web\Components\TwBootstrap\Widgets\Collection\Helpers\CollectionWidgetHelper::sortByField($attributeEntity->getLabel(), $attributeEntity->getSortAttribute(), $baseUrl, $queryParams);
            } else {
