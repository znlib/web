...
//        $this->routingConfigurator = $this->createRoutingConfigurator($this->routes);
    ...
    {
        $this->framework->setLayout($layout);
        $this->layout = $layout;
    }
    ...
    {
        $this->framework->setLayoutParams($layoutParams);
        $this->layoutParams = $layoutParams;
    }

    public function addLayoutParam(string $name, $value): void
    {
        $this->framework->addLayoutParam($name, $value);
...
//        try {
//            // @var HttpFramework $framework */
////            $framework = $this->container->get(HttpFramework::class);
////            $framework = new HttpFramework($this->routes, $this->container);
////            $this->framework->setLayout($this->getLayout());
////            $this->framework->setLayoutParams($this->getLayoutParams());
////            dd($this->subscribes());
////            $framework->getEventDispatcher()->
//            $response = $this->framework->handle($request); // ->send();
//
...
//        }
    ...
    {
        $this->framework->setErrorController($errorController);
